...
//            } else {
	...
	public Status do_GET_ListFunction(Database db, String designDocID, String viewName) throws CouchbaseLiteException {
        return executeList(db, designDocID, viewName);
	}
    ...
    private Status executeList(Database db, String designDocID, String viewName) throws CouchbaseLiteException {
        ...
        final Object responseObject = connection.getResponseObject();
        final Map<String, Object> properties = responseObject instanceof Map? (Map)responseObject : connection.getResponseBody().getProperties();
