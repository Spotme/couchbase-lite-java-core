...
//        database = SQLiteStorageEngineFactory.createStorageEngine();
    ...
    public Map<String, Object> documentPropertiesFromJSON(byte[] json, String docId, String revId, boolean deleted, long sequence, EnumSet<TDContentOptions> contentOptions) {
        ...
        return mapJsonToObject(json, extra);
    }

    @InterfaceAudience.Private
    public Map<String, Object> mapJsonToObject(byte[] json, Map<String, Object> extra) {
        Map<String, Object> docProperties;
        try {
            docProperties = Manager.getMapReader().readValue(json);
     ...
     */
    @InterfaceAudience.Private
    public void insertAttachmentForSequenceWithNameAndType(long sequence, String name, String contentType,
                                                           int revpos, BlobKey key, long length,
                                                           AttachmentInternal.AttachmentEncoding encoding,
                                                           long encodedLength) throws CouchbaseLiteException {
        try {
            ContentValues args = new ContentValues();
