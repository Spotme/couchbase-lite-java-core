...
public final class Pusher extends Replication implements Database.ChangeListener {
     ...
     */
    @InterfaceAudience.Private
    /* package */ public Pusher(Database db, URL remote, String replID, String remoteDbUuid, boolean continuous, ScheduledExecutorService workExecutor) {
            ...
            if (attachment.containsKey("follows")) {
	            ...
	            if (inputStream == null) {
                    ...
                    if (attachment.containsKey("length")) {
                        content_length = (Integer) attachment.get("length");
                    }
		            InputStreamBody inputStreamBody = new InputStreamBody(inputStream, contentType, attachmentFileName, content_length);
